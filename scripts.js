...
let links = [
	...
	// },
	{
		...
		link: [
			{
				name: "jira",
				link: "https://crackle.atlassian.net/secure/RapidBoard.jspa?rapidView=222&projectKey=CD",
			},
			{
				name: "github",
				link: "https://github.com/CrackleEngineering/CrackleConnectedDevices/pulls",
			},
			{
				name: "manual build",
				link: "https://github.com/CrackleEngineering/CrackleConnectedDevices/actions/workflows/dispatch.yml",
			},
			{
				name: "bitmovin docs",
				link: "https://cdn.bitmovin.com/player/web/staging/8/docs/index.html",
			},
			{ name: "local", link: "http://192.168.1.3:3000/crackle-vizio" },
			{
				name: "qat",
				link: "https://qat-connected-devices.crackle.com/crackle-vizio",
			},
			{
				name: "dev",
				link: "https://dev-connected-devices.crackle.com/crackle-vizio",
			},
			{
				name: "pre-prod",
				link: "https://preprod-connected-devices.crackle.com/crackle-vizio/",
			},
			{ name: "tv", link: "http://192.168.1.20:9555" },
			{
				name: "sideloader",
				link: "https://vizio-pm.s3-us-west-1.amazonaws.com/conjure-launcher.html",
			},
			{
				name: "google drive",
				link: "https://drive.google.com/drive/folders/1kT3muw3VhRU5k5C77Ubumjv1047-e_uE",
			},
		],
	},
	{
		...
		link: [
			{
				name: "jira",
				link: "https://jira.redspace.com/secure/RapidBoard.jspa?rapidView=1079&projectKey=NAWR",
			},
			{
				name: "stash",
				link: "https://stash.redspace.com/projects/VIAC/repos/nick-frontend/pull-requests",
			},
			{ name: "okta", link: "https://redspace.okta.com/app/UserHome" },
			{
				name: "dev backend",
				link: "https://dev-nick-wp-backend.nickanimationdev.com/",
			},
			{
				name: "dev frontend",
				link: "https://dev-nick-frontend.nickanimationdev.com/",
			},
			{
				name: "prod backend",
				link: "https://prod-wp-backend.nickanimationdev.com/wp-admin/",
			},
			{
				name: "prod frontend",
				link: "https://prod-frontend.nickanimationdev.com/",
			},
		],
	},
	{
		...
		link: [
			...
			{
				name: "payworks",
				link: "https://payroll.payworks.ca/Loginscreen.asp?err=loggedoff&LangID=",
			},
			{
